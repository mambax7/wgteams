		...
		<{if $members_count}>
			...
			<{foreach item=member from=$members_list}>
				<tr class="<{cycle values='odd, even'}>">
					...
					<a href="members.php?op=edit&amp;member_id=<{$member.id}>" title="<{$smarty.const._EDIT}>"><img src="<{xoModuleIcons16 edit.png}>" alt="members"></a>
					<a href="members.php?op=delete&amp;member_id=<{$member.id}>" title="<{$smarty.const._DELETE}>"><img src="<{xoModuleIcons16 delete.png}>" alt="members"></a>
					</td>
				</tr>
			<{/foreach}>
			</tbody>
